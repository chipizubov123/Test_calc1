...
public class Calculator_2 {
    ...
    static int Value(String s) {
        try {
            return switch (s) {
                ...
                case "IX" -> 9;
                case "X" -> 10;
                default -> throw new Exception("Некорректно введено выражение. Выражение должно содержать только арабские или только римские цифры от 1 до 10 и обязательно один знак: 1 + 1 или I + V");
            };
        } catch (Exception e) {
    ...
    static String Calculated() {
        ...
        try {
            ...
            }else {throw new Exception("Некорректно введено выражение. Выражение должно содержать только арабские или только римские цифры от 1 до 10 и обязательно один знак: 1 + 1 или I + V");}
        } catch (Exception e) {
            System.out.println("Некорректно введено выражение. Выражение должно содержать только арабские или только римские цифры от 1 до 10 и обязательно один знак: 1 + 1 или I + V");
        }
        return s1;
    ...
    public static void main(String[] args) {
        try {do {
            System.out.println("Итог выражения : " + StringToNumber());
        }while (true);
        }catch (Exception e){
            System.out.println("Некорректно введено выражение. Выражение должно содержать только арабские или только римские цифры от 1 до 10 и обязательно один знак: 1 + 1 или I + V");
        }
